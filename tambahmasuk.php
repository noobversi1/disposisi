    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg bg-body-tertiary mb-2">
            <div class="container-fluid">
                <a class="navbar-brand" href="masuk.php">Kembali</a>
            ...
            <div class="row">
                <div class="col-md-5 col-sm-6 col-lg-5 mx-auto">
                    <div class="formContainer">
                        <h2 class="p-2 text-center mb-4 h4" id="formHeading">Tambah Surat Masuk</h2>
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3">
                                <label class="mb-2" for="tgl_diterima">Tanggal Diterima</label>
                                <input class="form-control" type="date" id="tgl_diterima" name="tgl_diterima" required />
                            </div>
                            <div class="form-group mt-3">
                                <label class="mb-2" for="pengirim">Nama Pengirim / Instansi</label>
                                <input class="form-control" type="text" id="pengirim" name="pengirim" required />
                            </div>
                            <div class="form-group mt-3">
